...
class FloLexer(Lexer):
    ...
    tokens = { IDENTIFIANT, ENTIER, BOOLEAN, ECRIRE , SI, SINON_SI, SINON, TANT_QUE, RETOURNER, INFERIEUR_OU_EGAL, EGAL, INFERIEUR, SUPERIEUR, SUPERIEUR_OU_EGAL, DIFFERENT, ET, OU, NON, LIRE, VRAI, FAUX }
