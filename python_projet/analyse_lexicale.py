...
class FloLexer(Lexer):
	...
	tokens = { IDENTIFIANT, ENTIER, BOOLEAN, ADDITION, SOUSTRACTION, MULTIPLICATION, DIVISION, MODULO, ECRIRE,INFERIEUR_OU_EGAL, EGAL, INFRIEUR, SUPERIEUR, SUPERIEUR_OU_EGAL, DIFFERENT, ET, OU, NON }
