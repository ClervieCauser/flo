...
class FloLexer(Lexer):
	...
	tokens = { IDENTIFIANT, ENTIER, BOOLEAN, ADDITION, SOUSTRACTION, MULTIPLICATION, DIVISION, ECRIRE,INFERIEUR_OU_EGAL, EGAL, INFRIEUR, SUPERIEUR, SUPERIEUR_OU_EGAL, DIFFERENT }
