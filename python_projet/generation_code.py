...
def gen_operation(operation):
	...
	if op == '/':
		nasm_instruction("", "edx", "", "", "initialisation de edx")
		nasm_instruction(code[op], "ebx", "", "", "effectue l'opration eax "+op+"ebx et met le resulat dans eax")
	if op == '%':
		nasm_instruction("", "edx", "", "", "initialisation de edx")
		nasm_instruction(code[op], "edx", "", "", "effecture l'operation eax "+op+"ebx et met le resulat dans edx")
